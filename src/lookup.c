...
// NOTE: Temporarily moved this mess here whilst we work on file loading
...
// TODO: Make custom file format! Yippee that'll be fun :))
const TerrainHex regular_hexes[REGULAR_HEXES] = {
...
const Port regular_ports[REGULAR_PORTS] = {
...
const u8 regular_hex_values[REGULAR_HEXES] = {
    5, 2, 6, 3, 8, 10, 9, 12, 11, 4, 8, 10, 9, 4, 5, 6, 3, 11,
};
const u8 regular_port_locations[REGULAR_PORTS][2] = {
    {0, 3},
    {1, 5},
    {10, 15},
    {26, 32},
...
const u8 regular_hex_to_vertices[REGULAR_HEXES][6] = {
    {2, 5, 6, 9, 10, 14},
    {1, 4, 5, 8, 9, 13},
    {0, 3, 4, 7, 8, 12},
    {7, 11, 12, 16, 17, 22},
...
const u8 regular_vertices_to_edges[REGULAR_VERTICES][3] = {
    {0, 1, MAX_BOARD_EDGES},
    {2, 3, MAX_BOARD_EDGES},
    {4, 5, MAX_BOARD_EDGES},
    {0, 6, MAX_BOARD_EDGES},
...
const u8 regular_edge_to_vertices[REGULAR_EDGES][2] = {
    {0, 3},
    {0, 4},
    {1, 4},
    {1, 5},
...
const TerrainHex expansion_hexes[EXPANSION_HEXES] = {
...
const Port expansion_ports[EXPANSION_PORTS] = {
...
const u8 expansion_hex_values[EXPANSION_HEXES] = {
    2, 5, 4, 6, 3, 9, 8, 11, 11, 10, 6, 3, 8, 4, 8,
    10, 11, 12, 10, 5, 4, 9, 5, 9, 12, 3, 2, 6
};
const u8 expansion_port_locations[EXPANSION_PORTS][2] = {};
const u8 expansion_hex_to_vertices[EXPANSION_HEXES][6] = {};
const u8 expansion_vertices_to_edges[EXPANSION_VERTICES][3] = {};
const u8 expansion_edge_to_vertices[EXPANSION_EDGES][2] = {};
